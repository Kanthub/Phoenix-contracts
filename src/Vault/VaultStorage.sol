...
contract VaultStorage {
    ...
    event WithdrawalProposed(address indexed to, address indexed asset, uint256 amount, uint256 unlockTime); // Withdrawal proposal event
    event WithdrawalExecuted(address indexed to, address indexed asset, uint256 amount); // Withdrawal execution event
    ...
    event WithdrawalCancelled(address indexed by, address indexed asset, uint256 amount);
